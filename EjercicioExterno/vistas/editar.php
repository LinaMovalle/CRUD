...
<?php
      ...
      ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" value="<?=$row[1]?>">
        </div>
        <div class="mb-3">
            <label  class="form-label">Referencia</label>
            <input type="text" class="form-control" id="referencia" name="referencia" value="<?=$row[2]?>">
        </div>
        <div class="mb-3">
            <label class="form-label">precio</label>
            <input type="number" class="form-control" id="precio" name="precio"  value="<?=$row[3]?>">
        </div>
        <div class="mb-3">
            <label class="form-label">peso</label>
            <input type="number" class="form-control" id="peso" name="peso"  value="<?=$row[4]?>">
        </div>
        <div class="mb-3">
            <label  class="form-label">categoria</label>
            <input type="text" class="form-control" id="categoria" name="categoria"  value="<?=$row[5]?>">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">stock</label>
            <input type="number" class="form-control" id="stock" name="stock"  value="<?=$row[6]?>">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">fecha de creación</label>
            <input type="Date" class="form-control" id="fecha" name="fecha"  value="<?=$row[7]?>">
        </div>
        <?php
            }
            ?>
