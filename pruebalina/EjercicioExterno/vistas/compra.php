...
<?php
      ...
      ?>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" readonly onmousedown="return false;" id="stock" name="stock"  value="<?=$row[6]?>">
        </div>
        <div class="mb-3">
            ...
            ?>
            <input type="number" class="form-control" id="cantidad" name="cantidad"  min="1" max="<?=$row[6]?>" required> <!--Solo va a permitir la cantidad del stock-->
        </div>
        <div class="mb-3">
